...
print(Error_test, "OLS Error Test")

# b)Ridge implementation
...
for i in range(nlambdas):
    ...
    Error_train_ridge = MSE(z_train, z_est_train_ridge)
    Score_train_ridge = R2(z_train, z_est_train_ridge)
    Error_test_ridge = MSE(z_test, z_est_test_ridge)
    Score_test_ridge = R2(z_test, z_est_test_ridge)
    print(f"Lambda ridge: {lmbda}")
    print("Training MSE:", Error_train_ridge)
    print("Training R2:", Score_train_ridge)
    print("Test MSE:", Error_test_ridge)
    print("Test R2:", Score_test_ridge)


# C) Lasso implementation
...
for i in range(nlambdas):
    ...
    Error_train_lasso = MSE(z_train, z_est_train_lasso)
    Score_train_lasso = R2(z_train, z_est_train_lasso)
    Error_test_lasso = MSE(z_test, z_est_test_lasso)
    Score_test_lasso = R2(z_test, z_est_test_lasso)
    print(f"Lambda lasso: {lmbda}")
    print("Training MSE:", Error_train_lasso)
    print("Training R2:", Score_train_lasso)
    print("Test MSE:", Error_test_lasso)
    print("Test R2:", Score_test_lasso)
